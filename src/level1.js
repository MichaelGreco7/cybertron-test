...
const result = map(val => val **3, numbers)
...
const divBy6 = filter(numbers => numbers % 6 === 0, numbers)
return divBy6 // return answer here
}
...
const triple = map(num => num * 3)
const even = filter(num => num % 2 === 0)
const add = reduce((acc, num) => acc + num, 0)
...
const results = map(numbers => Math.sqrt(numbers), numbers)
return results
}
...
const tenAnd20 = filter(numbers => numbers > 10 && numbers < 20, numbers)
return tenAnd20 // return answer here
}
